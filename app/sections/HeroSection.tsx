  ...
  return (
    <section className="relative min-h-screen w-full">
      <Image
        ...
        height={1000}
      />
      <div className="relative z-20 mx-auto flex min-h-screen w-full max-w-6xl flex-col items-center justify-center gap-8 px-5 pt-28 sm:flex-row sm:items-center sm:justify-between sm:pt-0 md:px-0">
